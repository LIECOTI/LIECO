# OverlaySpinnerPreference | Miuix
...
## Import [​](https://compose-miuix-ui.github.io/miuix/components/overlayspinnerpreference#import)
...
## Basic Usage [​](https://compose-miuix-ui.github.io/miuix/components/overlayspinnerpreference#basic-usage)
...
## Options with Icons and Summaries [​](https://compose-miuix-ui.github.io/miuix/components/overlayspinnerpreference#options-with-icons-and-summaries)
...
## Component States [​](https://compose-miuix-ui.github.io/miuix/components/overlayspinnerpreference#component-states)

### Disabled State [​](https://compose-miuix-ui.github.io/miuix/components/overlayspinnerpreference#disabled-state)
...
## Dialog Mode [​](https://compose-miuix-ui.github.io/miuix/components/overlayspinnerpreference#dialog-mode)
...
## Grouped Options [​](https://compose-miuix-ui.github.io/miuix/components/overlayspinnerpreference#grouped-options)
...
## Multi Select [​](https://compose-miuix-ui.github.io/miuix/components/overlayspinnerpreference#multi-select)
...
## Observe Expanded State [​](https://compose-miuix-ui.github.io/miuix/components/overlayspinnerpreference#observe-expanded-state)
...
## Properties [​](https://compose-miuix-ui.github.io/miuix/components/overlayspinnerpreference#properties)

### OverlaySpinnerPreference Properties (Dropdown Mode) [​](https://compose-miuix-ui.github.io/miuix/components/overlayspinnerpreference#overlayspinnerpreference-properties-dropdown-mode)
...
### Entry Overload Properties [​](https://compose-miuix-ui.github.io/miuix/components/overlayspinnerpreference#entry-overload-properties)
...
### Grouped Entries Overload Properties [​](https://compose-miuix-ui.github.io/miuix/components/overlayspinnerpreference#grouped-entries-overload-properties)
...
### OverlaySpinnerPreference Properties (Dialog Mode) [​](https://compose-miuix-ui.github.io/miuix/components/overlayspinnerpreference#overlayspinnerpreference-properties-dialog-mode)
...
### Dialog Entry Overload Properties [​](https://compose-miuix-ui.github.io/miuix/components/overlayspinnerpreference#dialog-entry-overload-properties)
...
### Dialog Grouped Entries Overload Properties [​](https://compose-miuix-ui.github.io/miuix/components/overlayspinnerpreference#dialog-grouped-entries-overload-properties)
...
### DropdownEntry Properties [​](https://compose-miuix-ui.github.io/miuix/components/overlayspinnerpreference#dropdownentry-properties)
...
### DropdownItem Properties [​](https://compose-miuix-ui.github.io/miuix/components/overlayspinnerpreference#dropdownitem-properties)
...
### DropdownColors Properties [​](https://compose-miuix-ui.github.io/miuix/components/overlayspinnerpreference#dropdowncolors-properties)
...
## Changelog[](https://compose-miuix-ui.github.io/miuix/components/overlayspinnerpreference#changelog)
...
---
Source: [OverlaySpinnerPreference | Miuix](https://compose-miuix-ui.github.io/miuix/components/overlayspinnerpreference)