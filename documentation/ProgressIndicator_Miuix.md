...
## Import [​](https://compose-miuix-ui.github.io/miuix/components/progressindicator#import)
...
## Basic Usage [​](https://compose-miuix-ui.github.io/miuix/components/progressindicator#basic-usage)

### Linear Progress Bar [​](https://compose-miuix-ui.github.io/miuix/components/progressindicator#linear-progress-bar)
...
### Circular Progress Indicator [​](https://compose-miuix-ui.github.io/miuix/components/progressindicator#circular-progress-indicator)
...
### Infinite Progress Indicator [​](https://compose-miuix-ui.github.io/miuix/components/progressindicator#infinite-progress-indicator)
...
## Component States [​](https://compose-miuix-ui.github.io/miuix/components/progressindicator#component-states)

All progress indicator components support both determinate and indeterminate progress states:

### Determinate Progress State [​](https://compose-miuix-ui.github.io/miuix/components/progressindicator#determinate-progress-state)
...
### Indeterminate Progress State [​](https://compose-miuix-ui.github.io/miuix/components/progressindicator#indeterminate-progress-state)
...
## Properties [​](https://compose-miuix-ui.github.io/miuix/components/progressindicator#properties)

### LinearProgressIndicator Properties [​](https://compose-miuix-ui.github.io/miuix/components/progressindicator#linearprogressindicator-properties)
...
### CircularProgressIndicator Properties [​](https://compose-miuix-ui.github.io/miuix/components/progressindicator#circularprogressindicator-properties)
...
### InfiniteProgressIndicator Properties [​](https://compose-miuix-ui.github.io/miuix/components/progressindicator#infiniteprogressindicator-properties)
...
### ProgressIndicatorDefaults Object [​](https://compose-miuix-ui.github.io/miuix/components/progressindicator#progressindicatordefaults-object)

The ProgressIndicatorDefaults object provides default values and color configurations for progress indicator components.

#### Constants [​](https://compose-miuix-ui.github.io/miuix/components/progressindicator#constants)
...
#### Methods [​](https://compose-miuix-ui.github.io/miuix/components/progressindicator#methods)

| Method Name | Type | Description |
| --- | --- | --- |
| progressIndicatorColors() | ProgressIndicatorColors | Creates default color configuration for indicators |

### ProgressIndicatorColors Class [​](https://compose-miuix-ui.github.io/miuix/components/progressindicator#progressindicatorcolors-class)
...
## Advanced Usage [​](https://compose-miuix-ui.github.io/miuix/components/progressindicator#advanced-usage)

### Custom Colored Linear Progress Bar [​](https://compose-miuix-ui.github.io/miuix/components/progressindicator#custom-colored-linear-progress-bar)
...
### Resized Circular Progress Indicator [​](https://compose-miuix-ui.github.io/miuix/components/progressindicator#resized-circular-progress-indicator)
...
### Loading State with Button [​](https://compose-miuix-ui.github.io/miuix/components/progressindicator#loading-state-with-button)
...
### Custom Infinite Progress Indicator [​](https://compose-miuix-ui.github.io/miuix/components/progressindicator#custom-infinite-progress-indicator)
...
### Loading State with Card [​](https://compose-miuix-ui.github.io/miuix/components/progressindicator#loading-state-with-card)
...
## Changelog[](https://compose-miuix-ui.github.io/miuix/components/progressindicator#changelog)
...
---
Source: [ProgressIndicator | Miuix](https://compose-miuix-ui.github.io/miuix/components/progressindicator)