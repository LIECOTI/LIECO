...
## Using MiuixTheme [​](https://compose-miuix-ui.github.io/miuix/guide/theme#using-miuixtheme)
...
### Specific Modes [​](https://compose-miuix-ui.github.io/miuix/guide/theme#specific-modes)
...
## ThemeController [​](https://compose-miuix-ui.github.io/miuix/guide/theme#themecontroller)

The `ThemeController` manages the current color scheme of the Miuix theme.

### ThemeController Properties [​](https://compose-miuix-ui.github.io/miuix/guide/theme#themecontroller-properties)
...
### ColorSchemeMode [​](https://compose-miuix-ui.github.io/miuix/guide/theme#colorschememode)
...
### ThemePaletteStyle [​](https://compose-miuix-ui.github.io/miuix/guide/theme#themepalettestyle)
...
### ThemeColorSpec [​](https://compose-miuix-ui.github.io/miuix/guide/theme#themecolorspec)
...
## MiuixTheme Object [​](https://compose-miuix-ui.github.io/miuix/guide/theme#miuixtheme-object)
...
## Customizing the Theme [​](https://compose-miuix-ui.github.io/miuix/guide/theme#customizing-the-theme)
...
## Follow System Dark Mode [​](https://compose-miuix-ui.github.io/miuix/guide/theme#follow-system-dark-mode)
...
## Changelog[](https://compose-miuix-ui.github.io/miuix/guide/theme#changelog)
...
---
Source: [Theme System | Miuix](https://compose-miuix-ui.github.io/miuix/guide/theme)