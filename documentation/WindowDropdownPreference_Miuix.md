# WindowDropdownPreference | Miuix
...
## Import [​](https://compose-miuix-ui.github.io/miuix/components/windowdropdownpreference#import)
...
## Basic Usage [​](https://compose-miuix-ui.github.io/miuix/components/windowdropdownpreference#basic-usage)
...
## Dropdown with Summary [​](https://compose-miuix-ui.github.io/miuix/components/windowdropdownpreference#dropdown-with-summary)
...
## Observe Expanded State [​](https://compose-miuix-ui.github.io/miuix/components/windowdropdownpreference#observe-expanded-state)
...
## Custom Entries [​](https://compose-miuix-ui.github.io/miuix/components/windowdropdownpreference#custom-entries)
...
## Grouped Dropdown [​](https://compose-miuix-ui.github.io/miuix/components/windowdropdownpreference#grouped-dropdown)
...
## Multi Select [​](https://compose-miuix-ui.github.io/miuix/components/windowdropdownpreference#multi-select)
...
## Component States [​](https://compose-miuix-ui.github.io/miuix/components/windowdropdownpreference#component-states)

### Disabled State [​](https://compose-miuix-ui.github.io/miuix/components/windowdropdownpreference#disabled-state)
...
## Properties [​](https://compose-miuix-ui.github.io/miuix/components/windowdropdownpreference#properties)

### WindowDropdownPreference Properties [​](https://compose-miuix-ui.github.io/miuix/components/windowdropdownpreference#windowdropdownpreference-properties)
...
### Entry Overload Properties [​](https://compose-miuix-ui.github.io/miuix/components/windowdropdownpreference#entry-overload-properties)
...
### Grouped Entries Overload Properties [​](https://compose-miuix-ui.github.io/miuix/components/windowdropdownpreference#grouped-entries-overload-properties)
...
### DropdownEntry Properties [​](https://compose-miuix-ui.github.io/miuix/components/windowdropdownpreference#dropdownentry-properties)
...
### DropdownItem Properties [​](https://compose-miuix-ui.github.io/miuix/components/windowdropdownpreference#dropdownitem-properties)
...
### DropdownColors Properties [​](https://compose-miuix-ui.github.io/miuix/components/windowdropdownpreference#dropdowncolors-properties)
...
## Changelog[](https://compose-miuix-ui.github.io/miuix/components/windowdropdownpreference#changelog)
...
---
Source: [WindowDropdownPreference | Miuix](https://compose-miuix-ui.github.io/miuix/components/windowdropdownpreference)