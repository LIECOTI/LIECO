# OverlayDropdownPreference | Miuix
...
## Import [​](https://compose-miuix-ui.github.io/miuix/components/overlaydropdownpreference#import)
...
## Basic Usage [​](https://compose-miuix-ui.github.io/miuix/components/overlaydropdownpreference#basic-usage)
...
## Dropdown with Summary [​](https://compose-miuix-ui.github.io/miuix/components/overlaydropdownpreference#dropdown-with-summary)
...
## Observe Expanded State [​](https://compose-miuix-ui.github.io/miuix/components/overlaydropdownpreference#observe-expanded-state)
...
## Custom Entries [​](https://compose-miuix-ui.github.io/miuix/components/overlaydropdownpreference#custom-entries)
...
## Grouped Dropdown [​](https://compose-miuix-ui.github.io/miuix/components/overlaydropdownpreference#grouped-dropdown)
...
## Multi Select [​](https://compose-miuix-ui.github.io/miuix/components/overlaydropdownpreference#multi-select)
...
## Component States [​](https://compose-miuix-ui.github.io/miuix/components/overlaydropdownpreference#component-states)

### Disabled State [​](https://compose-miuix-ui.github.io/miuix/components/overlaydropdownpreference#disabled-state)
...
## Properties [​](https://compose-miuix-ui.github.io/miuix/components/overlaydropdownpreference#properties)

### OverlayDropdownPreference Properties [​](https://compose-miuix-ui.github.io/miuix/components/overlaydropdownpreference#overlaydropdownpreference-properties)
...
### Entry Overload Properties [​](https://compose-miuix-ui.github.io/miuix/components/overlaydropdownpreference#entry-overload-properties)
...
### Grouped Entries Overload Properties [​](https://compose-miuix-ui.github.io/miuix/components/overlaydropdownpreference#grouped-entries-overload-properties)
...
### DropdownEntry Properties [​](https://compose-miuix-ui.github.io/miuix/components/overlaydropdownpreference#dropdownentry-properties)
...
### DropdownItem Properties [​](https://compose-miuix-ui.github.io/miuix/components/overlaydropdownpreference#dropdownitem-properties)
...
### DropdownColors Properties [​](https://compose-miuix-ui.github.io/miuix/components/overlaydropdownpreference#dropdowncolors-properties)
...
## Changelog[](https://compose-miuix-ui.github.io/miuix/components/overlaydropdownpreference#changelog)
...
---
Source: [OverlayDropdownPreference | Miuix](https://compose-miuix-ui.github.io/miuix/components/overlaydropdownpreference)