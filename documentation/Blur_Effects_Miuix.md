...
On Android, `miuix-blur` requires `minSdk` 33 (Android 13) or higher. All effects (blur, blend, noise, highlight) rely on `RuntimeShader`, which is only available from API 33. Apps with a lower `minSdk` that still want to include this library should gate blur-related code paths with [the capability checks described below](https://compose-miuix-ui.github.io/miuix/guide/blur#runtime-capability-checks).

## Setup [​](https://compose-miuix-ui.github.io/miuix/guide/blur#setup)
...
## Platform Support [​](https://compose-miuix-ui.github.io/miuix/guide/blur#platform-support)
...
### Runtime capability checks [​](https://compose-miuix-ui.github.io/miuix/guide/blur#runtime-capability-checks)

If your app has a lower `minSdk` than `miuix-blur` and you want to keep shipping a single APK, gate blur usage with the capability checks below. On Android they map to `Build.VERSION.SDK_INT` comparisons; on Skiko-based targets (Desktop, iOS, macOS, Web) they always return `true`.
...
## Basic Usage [​](https://compose-miuix-ui.github.io/miuix/guide/blur#basic-usage)
...
## Color Configuration [​](https://compose-miuix-ui.github.io/miuix/guide/blur#color-configuration)
...
## Blend Modes [​](https://compose-miuix-ui.github.io/miuix/guide/blur#blend-modes)

`BlurBlendMode` provides 40+ blend modes for color blending over the blurred backdrop.

### Standard Modes [​](https://compose-miuix-ui.github.io/miuix/guide/blur#standard-modes)
...
### Custom Modes [​](https://compose-miuix-ui.github.io/miuix/guide/blur#custom-modes)
...
### Example: Multiple Blend Layers [​](https://compose-miuix-ui.github.io/miuix/guide/blur#example-multiple-blend-layers)
...
## Advanced Usage [​](https://compose-miuix-ui.github.io/miuix/guide/blur#advanced-usage)

### Independent X/Y Blur Radii [​](https://compose-miuix-ui.github.io/miuix/guide/blur#independent-x-y-blur-radii)
...
### Foreground Blur (Content Masking) [​](https://compose-miuix-ui.github.io/miuix/guide/blur#foreground-blur-content-masking)
...
### Noise Dithering [​](https://compose-miuix-ui.github.io/miuix/guide/blur#noise-dithering)
...
### Low-Level API: drawBackdrop [​](https://compose-miuix-ui.github.io/miuix/guide/blur#low-level-api-drawbackdrop)
...
#### BackdropEffectScope Extensions [​](https://compose-miuix-ui.github.io/miuix/guide/blur#backdropeffectscope-extensions)
...
#### BackdropEffectScope Properties [​](https://compose-miuix-ui.github.io/miuix/guide/blur#backdropeffectscope-properties)
...
## Properties [​](https://compose-miuix-ui.github.io/miuix/guide/blur#properties)

### textureBlur / textureEffect Parameters [​](https://compose-miuix-ui.github.io/miuix/guide/blur#textureblur-textureeffect-parameters)
...
### BlurColors Properties [​](https://compose-miuix-ui.github.io/miuix/guide/blur#blurcolors-properties)
...
### BlurDefaults [​](https://compose-miuix-ui.github.io/miuix/guide/blur#blurdefaults)
...
## Edge Highlight [​](https://compose-miuix-ui.github.io/miuix/guide/blur#edge-highlight)
...
### With textureBlur (constant) [​](https://compose-miuix-ui.github.io/miuix/guide/blur#with-textureblur-constant)
...
### With drawBackdrop (reactive) [​](https://compose-miuix-ui.github.io/miuix/guide/blur#with-drawbackdrop-reactive)
...
### Built-in Tokens [​](https://compose-miuix-ui.github.io/miuix/guide/blur#built-in-tokens)
...
### Custom BloomStroke [​](https://compose-miuix-ui.github.io/miuix/guide/blur#custom-bloomstroke)
...
### Sensor-driven Tilt Parallax [​](https://compose-miuix-ui.github.io/miuix/guide/blur#sensor-driven-tilt-parallax)
...
### Edge Highlight Properties [​](https://compose-miuix-ui.github.io/miuix/guide/blur#edge-highlight-properties)

#### Highlight [​](https://compose-miuix-ui.github.io/miuix/guide/blur#highlight)
...
#### BloomStroke [​](https://compose-miuix-ui.github.io/miuix/guide/blur#bloomstroke)
...
#### LightSource [​](https://compose-miuix-ui.github.io/miuix/guide/blur#lightsource)
...
#### LightPosition [​](https://compose-miuix-ui.github.io/miuix/guide/blur#lightposition)
...
#### rememberTiltLight Parameters [​](https://compose-miuix-ui.github.io/miuix/guide/blur#remembertiltlight-parameters)
...
## Changelog[](https://compose-miuix-ui.github.io/miuix/guide/blur#changelog)
...
---
Source: [Blur Effects | Miuix](https://compose-miuix-ui.github.io/miuix/guide/blur)