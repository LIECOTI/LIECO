...
## Import [​](https://compose-miuix-ui.github.io/miuix/components/windowspinnerpreference#import)
...
## Basic Usage [​](https://compose-miuix-ui.github.io/miuix/components/windowspinnerpreference#basic-usage)
...
## Options with Icons and Summaries [​](https://compose-miuix-ui.github.io/miuix/components/windowspinnerpreference#options-with-icons-and-summaries)
...
## Component State [​](https://compose-miuix-ui.github.io/miuix/components/windowspinnerpreference#component-state)

### Disabled State [​](https://compose-miuix-ui.github.io/miuix/components/windowspinnerpreference#disabled-state)
...
## Dialog Mode [​](https://compose-miuix-ui.github.io/miuix/components/windowspinnerpreference#dialog-mode)
...
## Grouped Options [​](https://compose-miuix-ui.github.io/miuix/components/windowspinnerpreference#grouped-options)
...
## Multi Select [​](https://compose-miuix-ui.github.io/miuix/components/windowspinnerpreference#multi-select)
...
## Observe Expanded State [​](https://compose-miuix-ui.github.io/miuix/components/windowspinnerpreference#observe-expanded-state)
...
## Properties [​](https://compose-miuix-ui.github.io/miuix/components/windowspinnerpreference#properties)

### WindowSpinnerPreference Properties (Popup Mode) [​](https://compose-miuix-ui.github.io/miuix/components/windowspinnerpreference#windowspinnerpreference-properties-popup-mode)
...
### Entry Overload Properties [​](https://compose-miuix-ui.github.io/miuix/components/windowspinnerpreference#entry-overload-properties)
...
### Grouped Entries Overload Properties [​](https://compose-miuix-ui.github.io/miuix/components/windowspinnerpreference#grouped-entries-overload-properties)
...
### WindowSpinnerPreference Properties (Dialog Mode) [​](https://compose-miuix-ui.github.io/miuix/components/windowspinnerpreference#windowspinnerpreference-properties-dialog-mode)
...
### Dialog Entry Overload Properties [​](https://compose-miuix-ui.github.io/miuix/components/windowspinnerpreference#dialog-entry-overload-properties)
...
### Dialog Grouped Entries Overload Properties [​](https://compose-miuix-ui.github.io/miuix/components/windowspinnerpreference#dialog-grouped-entries-overload-properties)
...
### DropdownEntry Properties [​](https://compose-miuix-ui.github.io/miuix/components/windowspinnerpreference#dropdownentry-properties)
...
### DropdownItem Properties [​](https://compose-miuix-ui.github.io/miuix/components/windowspinnerpreference#dropdownitem-properties)
...
### DropdownColors Properties [​](https://compose-miuix-ui.github.io/miuix/components/windowspinnerpreference#dropdowncolors-properties)
...
## Changelog[](https://compose-miuix-ui.github.io/miuix/components/windowspinnerpreference#changelog)
...
---
Source: [WindowSpinnerPreference | Miuix](https://compose-miuix-ui.github.io/miuix/components/windowspinnerpreference)