...
## Adding Dependencies [​](https://compose-miuix-ui.github.io/miuix/guide/getting-started#adding-dependencies)

To use Miuix in your project, follow these steps to add dependencies:

### Gradle (Kotlin DSL) [​](https://compose-miuix-ui.github.io/miuix/guide/getting-started#gradle-kotlin-dsl)
...
2.  Check the latest version on Maven Central: [![Maven Central](https://img.shields.io/maven-central/v/top.yukonga.miuix.kmp/miuix-ui)](https://search.maven.org/search?q=g:top.yukonga.miuix.kmp)
...
## Basic Usage [​](https://compose-miuix-ui.github.io/miuix/guide/getting-started#basic-usage)

### Applying the Miuix Theme [​](https://compose-miuix-ui.github.io/miuix/guide/getting-started#applying-the-miuix-theme)
...
### Using the Miuix Scaffold [​](https://compose-miuix-ui.github.io/miuix/guide/getting-started#using-the-miuix-scaffold)
...
## API Documentation [​](https://compose-miuix-ui.github.io/miuix/guide/getting-started#api-documentation)

-   View the [API Documentation](https://compose-miuix-ui.github.io/miuix/dokka/index.html), generated using Dokka, which contains detailed information about all APIs.

## Changelog[](https://compose-miuix-ui.github.io/miuix/guide/getting-started#changelog)
...
---
Source: [Getting Started | Miuix](https://compose-miuix-ui.github.io/miuix/guide/getting-started)